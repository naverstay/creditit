  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      if (!option.disabled) {
        ...
        return '<li id="' + option.dom_id + '" class="chzn_item ' + classes.join(' ') + '"' + style +' title="' + option.title + '">' + option.html + '</li>';
      } else {
        return "";
      }
    };
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        this.container.html('<a href="javascript:void(0)" class="chzn-single chzn-default" tabindex="-1">' +
								'<span class="">' + this.default_text + '</span>' +
								'<div>' +
									'<b></b>' +
								'</div>' +
							'</a>' +
